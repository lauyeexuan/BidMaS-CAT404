            ...
            <div class="flex justify-between items-start">
              ...
              <div class="mr-3 mt-1">
                <div class="w-8 h-8 rounded-full flex items-center justify-center"
                  ...
                  <!-- Examined icon -->
                  <svg v-else-if="notification.changeType.includes('assigned')" xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-green-600" viewBox="0 0 20 20" fill="currentColor">
